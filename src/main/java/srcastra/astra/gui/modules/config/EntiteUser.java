...
public class EntiteUser extends javax.swing.JInternalFrame implements MainScreenModule, AIframe, MailInterface, ModuleInterface {
    ...
    public EntiteUser(java.awt.Frame superOwner, astrainterface serveur, Loginusers_T currentUser, ActionToolBar toolbar, javax.swing.event.InternalFrameListener iFrameListener) {
    ...
    private void generatTabedPane() {
        ...
        try {
            ...
            panel[0] = new EntitePane(this, toolbar, serveur.renvEntiteRmiObject(currentUser.getUrcleunik()).getList(currentUser.getUrcleunik(), 0));

            panel[1] = new UserCOnfig(this, toolbar, serveur.renvUserRmiObject(currentUser.getUrcleunik()).getList(currentUser.getUrcleunik(), 0));

            toolbar.setTbComposer((ToolBarComposer) panel[0]);

            jTabbedPane1.add(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", currentUser.getLangage()).getString("entite"), (JPanel) panel[0]);

            jTabbedPane1.add(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", currentUser.getLangage()).getString("user"), (JPanel) panel[1]);
