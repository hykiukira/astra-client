...
public class UserTableModel extends javax.swing.table.AbstractTableModel implements ConfigModel {
    ...
    public User getObject(int row) {

        return (User) data.get(row);
    ...
    public Object getValueAt(int param, int param1) {
        ...
        User obj = (User) data.get(param);

        switch (param1) {

            case 0:
                return obj.getUrprenom();
