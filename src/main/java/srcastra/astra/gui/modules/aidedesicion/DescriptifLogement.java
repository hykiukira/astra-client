...
public class DescriptifLogement extends GeneriqueMemo {
    ...
    public DescriptifLogement(DossierMainScreenModule parent, ActionToolBar actionToolbar, astrainterface serveur, int typeDecision, boolean multiline, Hashtable generiqueVector) {
    ...
    protected void initComp() {
        ...
        compAfter.put(grp_Jradio_Hotel.getName(), new Object[]{grp_Jradio_Aviation, new Integer(produit_T.AV), new Integer(produit_T.HO)});

        //  compAfter.put(grp_Jradio_Taxi.getName(),new Object[]{grp_Jradio_Aviation,new Integer(produit_T.AV),new Integer(produit_T.TAX)});
        ...
        compBefore.put(grp_Jradio_Aviation.getName(), new Object[]{grp_Jradio_Hotel, new Integer(produit_T.HO)});
    ...
    protected void initComponents() {
        ...
        setBorder(new javax.swing.border.TitledBorder(null, java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10)));
        ...
        jPanel2.setBorder(new javax.swing.border.TitledBorder(null, java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_sub_title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10)));
        ...
        grp_Jradio_Aviation.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_lit"));
        ...
        grp_Jradio_Brochure.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_com"));
        ...
        grp_Jradio_Assurance.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_sit"));
        ...
        grp_Jradio_Bateau.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_vue"));
        ...
        grp_Jradio_Hotel.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_reg"));
