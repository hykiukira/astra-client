...
public class Divers extends GeneriqueMemo {
    ...
    public Divers(DossierMainScreenModule parent, ActionToolBar actionToolbar, astrainterface serveur, int typeDecision, boolean multiline, Hashtable generiqueVector) {
    ...
    protected void initComp() {
        ...
        compAfter.put(grp_Jradio_Brochure.getName(), new Object[]{grp_Jradio_Aviation, new Integer(produit_T.AV), new Integer(produit_T.BRO)});
        ...
        compBefore.put(grp_Jradio_Aviation.getName(), new Object[]{grp_Jradio_Brochure, new Integer(produit_T.BRO)});
    ...
    protected void initComponents() {
        ...
        setBorder(new javax.swing.border.TitledBorder(null, java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("desc_divers"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10)));
        ...
        grp_Jradio_Aviation.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("div_typres"));
        ...
        grp_Jradio_Brochure.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", parent.getCurrentUser().getLangage()).getString("div_typpay"));
