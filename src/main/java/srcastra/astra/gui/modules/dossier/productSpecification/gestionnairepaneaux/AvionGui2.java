...
public class AvionGui2 extends AbstractSousPanel {
    ...
    private ToolBarComposer m_mainPanel;


    public AvionGui2(DossierMainScreenModule parent, DossierProduitPane pane_produit, Config config) {
        ...
        panel = new NewAviationPanel(this);
    ...
    public String getTitle() {
        ...
        return java.util.ResourceBundle.getBundle("srcastra/astra/locale/ModuleDossier/DossierProduitPane", m_parent.getCurrentUser().getLangage()).getString("Titre_Pane_aviation");
    ...
    public void setBounds(int x, int y, int with, int heigth) {


        panel.setBounds(x, y, with, heigth);
    ...
    /**
     * Getter for property m_mainPanel.
     *
     * @return Value of property m_mainPanel.
     */


    public srcastra.astra.gui.components.actions.actionToolBar.ToolBarComposer getM_mainPanel() {
    ...
    /**
     * Setter for property m_mainPanel.
     *
     * @param m_mainPanel New value of property m_mainPanel.
     */


    NewAviationPanel panel;
