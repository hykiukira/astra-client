...
public class HotelGui extends AbstractSousPanel {
    ...
    public HotelGui(DossierMainScreenModule parent, DossierProduitPane pane_produit, Config config) {
    ...
    public String getTitle() {
        ...
        return java.util.ResourceBundle.getBundle("srcastra/astra/locale/ModuleDossier/DossierProduitPane", m_parent.getCurrentUser().getLangage()).getString("Titre_Pane_hotel");
