...
public class BateauGui extends AbstractSousPanel {
    ...
    public BateauGui(DossierMainScreenModule parent, DossierProduitPane pane_produit, Config config) {
