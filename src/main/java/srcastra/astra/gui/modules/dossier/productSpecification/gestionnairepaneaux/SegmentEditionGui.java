...
public class SegmentEditionGui extends AbstractSousPanel {
    ...
    public SegmentEditionGui(DossierMainScreenModule parent, DossierProduitPane pane_produit, Config config) {
        ...
        panel = new SegmentsEdition(this);
