 ...
 * @author  Thomas
 */
public class TaxiPanelEditionGui extends AbstractSousPanel{
    
    /** Creates a new instance of avionGui */
    public TaxiPanelEditionGui(DossierMainScreenModule parent, DossierProduitPane pane_produit, Config config) {
        super(parent,pane_produit);
        m_config=config;
        panel=new TaxiPanelEdition(this);
