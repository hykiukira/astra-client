...
public class Facturation2 extends javax.swing.JDialog implements srcastra.astra.gui.modules.dossier.productSpecification.gestionnairepaneaux.InterfaceMainPanel {
    ...
    public Facturation2(java.awt.Frame parent2, boolean modal, MainScreenModule parent, EditTable editable, ActionToolBar actionToolBar) {
    ...
    public void doAccept() {
        ...
        long hecleunik = ((Long) tmp[0]).longValue();


        long lignecleunik = ((Long) tmp[9]).longValue();
        ...
        try {
            ...
            facture.setResume(dossierrmi.getHistoriqueSelonProduit(parent.getCurrentUser().getUrcleunik(), lignecleunik));
