 ...
 * @author thomas
 */
public class NcFactService extends javax.swing.JInternalFrame implements MainScreenModule, AIframe, ActionListener, ToolBarComposer {
    ...
    public void achatParam() {
        //new AchatParam(parent.getSuperOwner(), true, this, editable, actionToolBar, getCategoriejournal()).show();// Add your handling code here:
...
//       grp_Label_achat.setText(achatc.getMontantFactPre().toString());
    ...
    public NcFactService(java.awt.Frame superOwner, astrainterface serveur, Loginusers_T currentUser, ActionToolBar actionToolBar, javax.swing.event.InternalFrameListener iFrameListener) {
...
//grp_Liste_journal.requestFocus();
    ...
    private void initListeBasicListe() {
        ...
        //srcastra.astra.gui.components.combobox.liste.JournauxCTableModel

        grp_Liste_journal.setModel(new srcastra.astra.gui.components.combobox.liste.JournauxCTableModelV(parent.getServeur(), parent.getCurrentUser()));
        ...
        grp_Liste_tiers.setModel(new srcastra.astra.gui.components.combobox.liste2.listemodel.SousClientListeTableModel(parent.getServeur(),parent.getCurrentUser()));
...
//  grp_Table_Achat.setFocusable(false);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        grp_li_periode.setGrp_Comp_nextComponent(grp_LSelect_Dossier_ClientContractuel);
        ...
        jPanel7.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 18, 80, -1));

        grp_Date_date.setGrp_Comp_nextComponent(grp_LSelect_Dossier);
        ...
        jPanel7.add(grp_Date_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 150, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 10));
        jLabel10.setText("Dossier");
        jPanel7.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 36, 80, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 10));
        jLabel4.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/compta", parent.getCurrentUser().getLangage()).getString("cli"));
        jLabel4.setPreferredSize(new java.awt.Dimension(80, 13));
        jPanel7.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 2, -1, -1));

        grp_LSelect_Dossier_ClientContractuel.setEnabled(false);
        grp_LSelect_Dossier_ClientContractuel.setGrp_Comp_nextComponent(grp_Date_date);
        ...
        jPanel7.add(grp_LSelect_Dossier_ClientContractuel, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, -1, -1));

        grp_LSelect_Dossier.setGrp_Comp_nextComponent(grp_Date_ech);
        ...
        jPanel7.add(grp_LSelect_Dossier, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 150, -1));
...
//grp_Liste_periode.setEnabled(enabled);
        grp_LSelect_Dossier_ClientContractuel.setEnabled(enabled);
        grp_LSelect_Dossier.setEnabled(enabled);
...
//  this.modeltva.setData(achatc.getTvamontant().toString());
    ...
    public static void main(String argv[]) {
        ...
        //NcFactService ncfs=new NcFactService();
