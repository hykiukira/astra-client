...
public class CaisseModel extends AbstractTableModel {
    ...
    public CaisseModel(MainScreenModule main, Loginusers_T user) {
        ...
        this.m_columns = new ColumnData[]{
                ...
                new ColumnData(loadName("cai_col_date"), 40, JLabel.LEFT),


                new ColumnData(loadName("cai_col_ope"), 5, JLabel.LEFT),


                new ColumnData(loadName("cai_col_numdos"), 35, JLabel.LEFT),


                new ColumnData(loadName("cai_col_periode"), 5, JLabel.LEFT),


                new ColumnData(loadName("cai_col_libele"), 85, JLabel.LEFT),
    ...
    public Object getValueAt(int param, int param1) {
        ...
        switch (param1) {
            ...
            case 0:
                return ((srcastra.astra.sys.classetransfert.utils.Date) obj[param1]).toString2();
            ...
            case 5:
                return checkTypePayement(obj, 5);


            case 6:
                return checkTypePayement(obj, 6);


            case 7:
                return checkTypePayement(obj, 7);
    ...
    private Object checkTypePayement(Object[] tab, int col) {
        ...
        if (((Integer) tab[5]).intValue() == srcastra.astra.sys.classetransfert.configuration.TypePayement.CARD) {
            ...
            if (col == 6) {
                ...
                // tab[4]=new Double(((Double)tab[4]).doubleValue()*-1);

                return new Double(((Double) tab[4]).doubleValue() * -1);
