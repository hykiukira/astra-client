...
public class ODModel extends srcastra.astra.gui.components.combobox.liste.ListeTableModel {
    ...
    public ODModel(MainScreenModule main, Loginusers_T user) {
        ...
        this.m_columns = new ColumnData[]{
                ...
                new ColumnData(loadName("oddoc"), 30, JLabel.LEFT),


                new ColumnData(loadName("oddatedoc"), 30, JLabel.LEFT),


                new ColumnData(loadName("oddatop"), 30, JLabel.LEFT),


                new ColumnData(loadName("odtype"), 10, JLabel.LEFT),


                new ColumnData(loadName("odref"), 100, JLabel.LEFT),

                new ColumnData(loadName("odsens"), 20, JLabel.LEFT),

                new ColumnData(loadName("odmontant"), 30, JLabel.LEFT),

                new ColumnData(loadName("odcom"), 100, JLabel.LEFT),
