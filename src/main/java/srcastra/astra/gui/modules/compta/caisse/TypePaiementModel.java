...
public class TypePaiementModel extends AbstractTableModel implements srcastra.astra.gui.modules.config.ConfigModel {
    ...
    public TypePaiementModel(MainScreenModule main, Loginusers_T user) {
    ...
    public Object getValueAt(int param, int param1) {
        ...
        srcastra.astra.sys.classetransfert.configuration.TypePayement pay = (srcastra.astra.sys.classetransfert.configuration.TypePayement) data.get(param);
        ...
        switch (param1) {
            ...
            case 0:
                return pay.getTynt_libelle1();


            case 1:
                return pay.getTynt_libelle2();
