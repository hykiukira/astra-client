 ...
 * @author  Thomas
 */
public class PRAS_Bloque extends AbstractBloque{
    
    /** Creates a new instance of RHBloqueGauche */
      Assurance_T assurance;
      public PRAS_Bloque(Object obj, Object obj2, Object obj3, Object obj4, double x, double y, RReport report, RArea parent,Assurance_T assurance, java.awt.Frame frame) {
    ...
    protected void initField(int fcase, int color, int igenerique, String sgenerique, java.awt.Font font){      
       // BonCommandeText=new MyRvfield(fcase,color,"Bon de Commande",igenerique,sgenerique,fontBold12);
        fpolice=new MyRvfield(fcase,color,assurance.getAce_numPolice(),igenerique,sgenerique,font);
    ...
    protected void initLabel(int fcase, int color, int igenerique, String sgenerique, java.awt.Font font){
         police=new MyRvfield(fcase,color,java.util.ResourceBundle.getBundle("srcastra.astra.edition.BonDeCommande", currentUser.getLangage()).getString("PR_AS_police"),igenerique,sgenerique,font);
    ...
    */}
    protected void genereArray(){
        ...
        fieldArray.add(new MyRvfield[]{police,fpolice});
