...
public class TvaDetailTotal extends AbstractBloque{
    ...
    public TvaDetailTotal(Object obj, Object obj2, Object obj3, Object obj4, double x, double y, ArrayList genprint, java.awt.Frame frame, RReport report, Hashtable tvahash) {

          super(obj,obj2,obj3,obj4,frame,report); 

          this.tvahash=tvahash;

          initField(1,1,1,"",fontBold10,genprint);  
    ...
    protected void initField(int fcase, int color, int igenerique, String sgenerique, java.awt.Font font,ArrayList genprint) {
        ...
        fieldArray=new ArrayList(); 
            ...
            MyRvfield[] myfields=new MyRvfield[3];           
                 ...
                 myfields[0]=new MyRvfield(fcase,color,new Double(MathRound.roundThisToDouble(dossier.getDrprix())).toString(),igenerique,sgenerique,font);

                 myfields[0].Expand=true;

                 myfields[0].multiLine=false;     

                 myfields[1]=new MyRvfield(fcase,color, new Double(MathRound.roundThisToDouble(dossier.getDrtva())).toString(),igenerique,sgenerique,font);

                 myfields[1].Expand=true;

                 myfields[1].multiLine=false;

                 myfields[2]=new MyRvfield(fcase,color,new Double(MathRound.roundThisToDouble(dossier.getDrtotalprix())).toString()+"€",igenerique,sgenerique,font);
    ...
    public void initFieldPosition(double x1,double x2,double x3,double x4,double x5,double x6,double y){
        ...
        for(int i=0;i<fieldArray.size();i++){
            ...
            myfields[1].x=x3-3d;//-myfields[1].width;
            ...
            myfields[2].x=x4-3d;//-myfields[2].width;
