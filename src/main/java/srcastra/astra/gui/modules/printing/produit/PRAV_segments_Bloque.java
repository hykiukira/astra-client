 ...
 * @author  Thomas
 */
public class PRAV_segments_Bloque extends AbstractBloque{
    
    /** Creates a new instance of RHBloqueGauche */
      Avion_segment_T segment;
      public PRAV_segments_Bloque(Object obj, Object obj2, Object obj3, Object obj4, double x, double y, RReport report, RArea parent, Avion_segment_T segment, java.awt.Frame frame) {
    ...
    protected void initLabel(int fcase, int color, int igenerique, String sgenerique, java.awt.Font font){
        ...
        compagnie=new MyRvfield(fcase,color,java.util.ResourceBundle.getBundle("srcastra.astra.edition.BonDeCommande", currentUser.getLangage()).getString("PR_AV_numvol"),igenerique,sgenerique,font);
    ...
    protected void genereArray(){
       ...
       // fieldArray.add(new MyRvfield[]{routingde,routinta,compagnie,numerovol,classe,datedep,heuredep,heurearriv,conjonction});
         fieldArray.add(new MyRvfield[]{routingde,routinta,compagnie,classe,datedep,heuredep,heurearriv,conjonction});
