 ...
 * @author  thomas
 */
public class RepportFooter2 extends AbstractHeader{
    
    /** Creates a new instance of PassagerEdition1 */
    AbstractBuffer buffer;
    java.awt.Frame main;
    public RepportFooter2(Object obj, Object obj2, Object obj3, Object obj4, RReportJ2 report, double x, double y, ArrayList genprint, AbstractBuffer buffer, java.awt.Frame main,int facture)  {       
         super(obj,obj2,obj3,obj4);
         this.buffer=buffer;
          Dossier_T dossier=(Dossier_T)obj3;
          String memo="";
          
                    footer2=new FooterBloque2(obj,obj2,obj3,obj4,x,y,report,this,main,buffer,facture); 
                 // footer2.ajustBloque();
                  footer2.initLabelPosition(0,0);                   
                  addBloque(footer2); 
                  height=footer2.heigth;
