...
public class PayementEdition extends AbstractProduitEdition{
    ...
    double position=0;
      ...
      public PayementEdition(Object obj, Object obj2, Object obj3, RReportJ2 report, AbstractBuffer buffer, DossierRmiInterface dossin, java.awt.Frame main,String text)  {       

        super(obj,obj2,obj3,AbstractProduitEdition.PAY,report,text); 
    ...
    public void addProduct(Object obj,Object obj2,Object obj3,Object obj4,produit_T prod){
      ...
      /*  prix=new PrixBloque(obj,obj2,obj3,obj4,0,0,report,this,prod,main);   
    ...
    public void addProduct(Object obj, Object obj2, Object obj3, Object obj4, produit_T prod, String texte) {
        ...
        payementfooter=new PayementFooter(obj,obj2,obj3,obj4,0,0,report,this,null,main,buffer);

        // payement.initFieldPosition(0,y1);

      

         payementfooter.ajustBloque();

     //    payementfooter.initFieldPosition(0,y1);

         payementfooter.calculWidth();

         payementfooter.setPosition(0,y1,0d,0.4d);

         //payement.setPosition(0,fournisseur.y2+0.4d,0,0.4d); 

         addBloque(payementfooter);
    ...
    public void addProduct(Object obj, Object obj2, Object obj3, Object obj4, produit_T prod, String texte, Object obj5) {
         ...
         payement=new PayementBloque(obj,obj2,obj3,obj4,0,0,report,this,(Payement_T)obj5,main,buffer);

         payement.initFieldPosition(0,y1);

         payement.ajustBloque();

         payement.calculWidth();
...
AbstractBloque payement;    

AbstractBloque payementfooter;    
