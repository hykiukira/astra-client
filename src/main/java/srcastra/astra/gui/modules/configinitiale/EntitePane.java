...
public class EntitePane extends javax.swing.JPanel implements ToolBarComposer, GlobalInterface {
    ...
    srcastra.astra.gui.modules.configinitiale.ConfigMediator configM;

    public EntitePane(ActionToolBar toolbar, AbstractConfig_T config, srcastra.astra.gui.modules.configinitiale.ConfigMediator configM, Loginusers_T currentUser, astrainterface serveur) {
        ...
        parent = new substitutDossierModule(serveur, currentUser);
        ...
        activeToolbar(ActionToolBar.ACT_READ);

        this.configM = configM;

        this.configM.setEniteconf(this);
    ...
    public void activeToolbar(int type) {
        ...
        if (type == ActionToolBar.ACT_READ) {
            ...
            toolbar.setActionEnabled(new int[]{ActionToolBar.DO_PREVIOUS});
    ...
    private void setDocumentMask() {
        ...
        grp_Tfiel_nom.setDocument(new DefaultMask(1, 12, currentUser.getLangage(), DefaultMask.ALL_LETTRE_IN_UPPERCASE));

        grp_Tfiel_abrev.setDocument(new DefaultMask(1, 2, currentUser.getLangage(), DefaultMask.ALL_LETTRE_IN_UPPERCASE));

        grp_Tfiel_adresse.setDocument(new DefaultMask(0, 50, currentUser.getLangage(), DefaultMask.ALL_LETTRE_IN_UPPERCASE));
        ...
        grp_Tfiel_tel.setDocument(new DefaultMask(0, 100, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_Tfiel_tel21.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_Tfiel_fax1.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_Tfiel_email1.setDocument(new DefaultMask(0, 50, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_Tfiel_tva1.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_Tfiel_bank1.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Main company"));
        ...
        grp_Tfiel_tel.setGrp_Comp_nextComponent(grp_Tfiel_tel21);
        ...
        jLabel8.setText(java.util.ResourceBundle.getBundle("srcastra/astra/locale/generale", currentUser.getLangage()).getString("socmer"));

        jLabel8.setPreferredSize(new java.awt.Dimension(33, 13));
        ...
        jPanel61.add(jLabel8, gridBagConstraints);
        ...
        jPanel61.add(aCheckBox1, gridBagConstraints);
