...
public class UserCOnfig extends javax.swing.JPanel implements ToolBarComposer {
    ...
    srcastra.astra.gui.modules.configinitiale.Pwd pass;

    substitutDossierModule parent;

    srcastra.astra.gui.modules.configinitiale.ConfigMediator configM;

    public UserCOnfig(ActionToolBar toolbar, AbstractConfig_T config, srcastra.astra.gui.modules.configinitiale.ConfigMediator configM, Loginusers_T currentUser, astrainterface serveur) {
...
//        this.currentUser=parent.getCurrentUser();
    ...
    private void setDocumentMask() {
        ...
        grp_TField_telb.setDocument(new DefaultMask(0, 100, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_TField_telp.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_TField_emailb.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));

        grp_TField_emailp.setDocument(new DefaultMask(0, 15, currentUser.getLangage(), DefaultMask.CASE_UNSENSITIVE));
    ...
    public srcastra.astra.gui.modules.configinitiale.Pwd getPass() {
    ...
    public void setPass(srcastra.astra.gui.modules.configinitiale.Pwd pass) {
