...
public class EmbardDebarqtListeTableModel extends ListeTableModel implements ListeModelInterface {
    ...
    public EmbardDebarqtListeTableModel(astrainterface serveur, Loginusers_T login) {
    ...
    public ArrayList loadata() {
        ...
        try {
            ...
            m_vector = m_serveur.renvSignalitiques(m_login.getUrlmcleunik(), m_login.getUrcleunik(), 1, astrainterface.COMBO_EMBARQDEBARQ, true);
