 ...
 * @author  Sébastien
 */
public class LangueTableModel extends AbstractAstraTableModel {
    
    /** Creates a new instance of LangueTableModel */
    public LangueTableModel(astrainterface serveur, Loginusers_T currentUser) {
    ...
    protected String[] loadColumnNames() {
        try {
            java.util.ResourceBundle rb = java.util.ResourceBundle.getBundle("srcastra/astra/locale/tableHeader/signaletique/LangueTableHeader", currentUser.getLangage());
        ...
        return new String[] {"Abréviation", "Langues" };
    }
    ...
    protected ArrayList loadData() {
        ...
        try {
            retVal = serveur.renvSignalitiques(currentUser.getUrlmcleunik(),currentUser.getUrcleunik(),1,astrainterface.COMBO_LANGUE,true);
        }
