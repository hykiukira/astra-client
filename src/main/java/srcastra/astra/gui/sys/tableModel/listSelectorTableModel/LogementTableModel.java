 ...
 * @author  Sébastien
 */
public class LogementTableModel extends AbstractAstraTableModel {
    
    /** Creates a new instance of PaysTableModel */
    public LogementTableModel(astrainterface serveur, Loginusers_T currentUser) {
    ...
    protected String[] loadColumnNames() {
        try {
            java.util.ResourceBundle rb = java.util.ResourceBundle.getBundle("srcastra/astra/locale/tableHeader/signaletique/LogementTableHeader", currentUser.getLangage());
        ...
        return new String[] {"Logements", "Abréviations" };
    }
    ...
    protected ArrayList loadData() {
        ...
        try {
            retVal = serveur.renvSignalitiques(currentUser.getUrlmcleunik(),currentUser.getUrcleunik(),1,astrainterface.COMBO_LOGEMENT,true);
        }
