 ...
 * @author  Sébastien
 */
public class PaysTableModel extends AbstractAstraTableModel {
    
    /** Creates a new instance of PaysTableModel */
    public PaysTableModel(astrainterface serveur, Loginusers_T currentUser) {
    ...
    protected String[] loadColumnNames() {
        try {
            java.util.ResourceBundle rb = java.util.ResourceBundle.getBundle("srcastra/astra/locale/tableHeader/signaletique/PaysTableHeader", currentUser.getLangage());
        ...
        return new String[] {"Abréviation", "Pays" };
    }
    ...
    protected ArrayList loadData() {
        ...
        try {
            retVal = serveur.renvSignalitiques(currentUser.getUrlmcleunik(),currentUser.getUrcleunik(),1,astrainterface.COMBO_PAYS,true);
        }
