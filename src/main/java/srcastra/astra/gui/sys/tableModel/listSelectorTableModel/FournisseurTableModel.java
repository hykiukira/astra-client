 ...
 * @author  Sébastien
 */
public class FournisseurTableModel extends AbstractAstraTableModel {
    
    /** Creates a new instance of PaysTableModel */
    public FournisseurTableModel(astrainterface serveur, Loginusers_T currentUser) {
    ...
    protected String[] loadColumnNames() {
        try {
            java.util.ResourceBundle rb = java.util.ResourceBundle.getBundle("srcastra/astra/locale/tableHeader/signaletique/FournisseurTableHeader", currentUser.getLangage());
        ...
        return new String[] {"Références", "Noms" };
    }
    ...
    protected ArrayList loadData() {
        ...
        try {
            retVal = serveur.renvcombo('f',currentUser.getUrcleunik(),currentUser.getUrlmcleunik(),'p',"", 1);
        }
