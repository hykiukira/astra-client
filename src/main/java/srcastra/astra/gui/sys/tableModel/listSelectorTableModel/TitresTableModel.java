 ...
 * @author  Sébastien
 */
public class TitresTableModel extends AbstractAstraTableModel {
    
    /** Creates a new instance of PaysTableModel */
    public TitresTableModel(astrainterface serveur, Loginusers_T currentUser) {
    ...
    protected String[] loadColumnNames() {
        try {
            java.util.ResourceBundle rb = java.util.ResourceBundle.getBundle("srcastra/astra/locale/tableHeader/signaletique/TitresTableHeader", currentUser.getLangage());
        ...
        return new String[] {"Titres", "Abréviations" };
    }
    ...
    protected ArrayList loadData() {
        ...
        try {
            retVal = serveur.renvSignalitiques(currentUser.getUrlmcleunik(),currentUser.getUrcleunik(),1,astrainterface.COMBO_TITREPERSONNES,true);
        }
