 ...
 * @author  Sébastien
 */
public class TransportTableModel extends AbstractAstraTableModel {
    ...
    protected String[] loadColumnNames() {
        ...
        return new String[] {"Abréviations", "Transports" };
    }
    ...
    protected ArrayList loadData() {
        ...
        try {
            retVal = serveur.renvSignalitiques(currentUser.getUrlmcleunik(),currentUser.getUrcleunik(),1,astrainterface.COMBO_TRANSPORT,true);
        }
