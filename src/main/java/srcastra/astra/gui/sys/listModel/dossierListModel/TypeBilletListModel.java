 ...
 * @author  Sébastien
 */
public class TypeBilletListModel extends AbstractAstraListModel {
    
    /** Creates a new instance of TypeBListModel */
    public TypeBilletListModel(astrainterface serveur, Loginusers_T currentUser) {
    ...
    private String loadName(String key) {
        String retVal = ""; 
        try {
            retVal = java.util.ResourceBundle.getBundle("srcastra/astra/locale/tableHeader/signaletique/TypeBilletListHeader", currentUser.getLangage()).getString(key);
        }
