...
public class JGoodiesConfigJournaux implements JGoodiesConfig {
    ...
    public JGoodiesConfigJournaux(String langue, Loginusers_T currentUser, astrainterface serveur) {
    ...
    private void initComponents() {
        ...
        separator1 = java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("type");

        type = new JComboBox();


        departJ = new JLabel(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("d_mouv"));
        ...
        component = new Object[6][8];

        component[0][1] = new JComponent[]{type};

        type.addItem(new String(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("v")));
        type.addItem(new String(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("ncv")));
        type.addItem(new String(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("a")));
        type.addItem(new String(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("nca")));
        type.addItem(new String(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("od")));
