/*
 * JGoodiesConfigAchat.java
 *
 * Created on 22 mai 2006, 9:37
 */
/*
...
public class JGoodiesConfigAchat implements JGoodiesConfig {
    ...
    public JGoodiesConfigAchat(String langue, Loginusers_T currentUser, astrainterface serveur) {
    ...
    private void initComponents() {
       ...
       dCreationF=new JTextField(15);*/
        ...
        component = new Object[6][3];

        //component[0][2]=new JComponent[]{dCreation};

        component[0][1] = new JComponent[]{new JLabel(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("ch1")), ok};
        component[0][2] = new JComponent[]{new JLabel(java.util.ResourceBundle.getBundle("srcastra/astra/locale/listing", currentUser.getLangage()).getString("ch2")), notMatched};
