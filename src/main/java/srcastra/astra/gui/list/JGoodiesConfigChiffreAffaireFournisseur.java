...
public class JGoodiesConfigChiffreAffaireFournisseur implements JGoodiesConfig {
    ...
    public JGoodiesConfigChiffreAffaireFournisseur(String langue, Loginusers_T currentUser, astrainterface serveur) {
    ...
    private void initListe() {
        ...
        fourn2.setLogin(currentUser);

        fourn2.setModel(new srcastra.astra.gui.components.combobox.liste.FournisseurListeTableModel(serveur, currentUser));
    ...
    private void initComponents() {
       ...
       dCreationF=new ADate();*/
        ...
        component[0][2] = new JComponent[]{fourn};

        component[0][3] = new JComponent[]{de, fournl, a, fourn2};
    ...
    public String getFournisseur2() {
        ...
        return fourn2.getCleUnik() == 0 ? "%" : new Integer(fourn2.getCleUnik()).toString();

    }

    public String getFournisseurText2() {

        return fourn2.getText();//getCleUnik()==0?"%":new Integer(fournl.getCleUnik()).toString();
