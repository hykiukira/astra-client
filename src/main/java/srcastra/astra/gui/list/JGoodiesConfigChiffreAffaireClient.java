...
public class JGoodiesConfigChiffreAffaireClient implements JGoodiesConfig {
    ...
    public JGoodiesConfigChiffreAffaireClient(String langue, Loginusers_T currentUser, astrainterface serveur) {
