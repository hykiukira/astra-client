...
public class JGoodiesConfigDebEmb implements JGoodiesConfig {
    ...
    public JGoodiesConfigDebEmb(String langue, Loginusers_T currentUser, astrainterface serveur) {
    ...
    private void initComponents() {
       ...
       dCreationF=new ADate();*/
        ...
        de1 = new JLabel("Dossier");

        doss = new JTextField(8);

        ///doss.setSize(100,doss.getHeight());
        ...
        component[0][0] = new JComponent[]{this.de1, doss};
