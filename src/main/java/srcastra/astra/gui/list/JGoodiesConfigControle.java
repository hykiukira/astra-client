...
public class JGoodiesConfigControle implements JGoodiesConfig {
    ...
    public JGoodiesConfigControle(String langue, Loginusers_T currentUser, astrainterface serveur) {
    ...
    private void initComponents() {
        ...
        component[0][5] = new JComponent[]{piv, pivot};
