 ...
 * Created on 7 février 2003, 9:15
...
public class SupReducChain extends  AbstractLigneCompta implements Chain{

    

    /** Creates a new instance of SupReducChain */

    private Chain nextChain;

    private final static String ACTION="supreduc";

    public SupReducChain() {

    }

    public SupReducChain(Configuration config) {
    ...
    public void sendToChain(String action, Object obj2) throws java.rmi.RemoteException,srcastra.astra.sys.rmi.Exception.ServeurSqlFailure,java.sql.SQLException{
         ...
         if(obj2 instanceof Sup_reduc_T){          
            Command cmd=new SupreducCompta(obj2,getM_config()); 
