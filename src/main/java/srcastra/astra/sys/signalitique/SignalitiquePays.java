...
public class SignalitiquePays implements srcastra.astra.sys.signalitique.Signalitique {

    

    /** Creates a new instance of SignalitiquePays */

    public SignalitiquePays() {
    ...
    public CompressArray renvSignalitiques(int urlmcleunik, int urcleunik, int cas, Poolconnection connect) throws RemoteException {
        ...
        return renvSignalitiquePays(urlmcleunik,connect.getConuser(),cas, connect.getBuffer());
    ...
    private CompressArray renvSignalitiquePays(int urlmcleunik,Connection usercon,int cas, ServeurBuffer buf) {
        String tmplangue;
        String sqlrequete = null;
        CompressArray cp;
        ...
        synchronized (buf) {
            sqlrequete ="select p.pyscleunik,t.pystraduction,p.pysabrev"
                    ...
                    +" order by t.pystraduction;";
             return GestionnaireSignaletique.renvsignaletique(sqlrequete,urlmcleunik,buf,astrainterface.COMBO_PAYS,usercon,astrainterface.COMBO_PAYS_CAS+urlmcleunik,"paysDir");
        }
    }
  /*      String sqlrequete=null;
...
*/
    ...
    public void deleteSignaletique(long objectCleunik, int typeObjec, Poolconnection connect) throws ServeurSqlFailure {
        ...
        String requetepassager="SELECT pyscleunik FROM passager WHERE pyscleunik=? ";

        String requetehotel="SELECT pyscleunik FROM hotel WHERE pyscleunik=? OR  prestpycleunik=?";

        String deletepays="DELETE from pays WHERE pyscleunik=?";
        ...
        if(sw){
            ...
            connect.getBuffer().invalidateBuffer("paysDir");
