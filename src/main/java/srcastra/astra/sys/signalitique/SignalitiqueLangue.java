...
public class SignalitiqueLangue implements srcastra.astra.sys.signalitique.Signalitique {
    ...
    public CompressArray renvSignalitiques(int urlmcleunik, int urcleunik, int cas, Poolconnection connect) throws RemoteException {
        ...
        Logger.getDefaultLogger().log(Logger.LOG_INFOS,"[PPPPPPPPPPPPPPPPPP]cas"+cas);
    ...
    private CompressArray renvSignalitiqueLangue(int urlmcleunik,Connection usercon,int cas, ServeurBuffer buf) {
        ...
        synchronized (buf) {
            ...
            sqlrequete ="select l.lecleunik ,l.leabreviation,t.letraduction  from langue l,traductionlangues t where l.lecleunik=t.lecleunik  and t.lmcleunik="+urlmcleunik+" order by l.leabreviation";
