 ...
 * @author  rene
 */
public class SignalitiqueSupReductGroupeDecision implements srcastra.astra.sys.signalitique.Signalitique {
    
    /** Creates a new instance of SignalitiqueFournisseurGroupeDecision */
    public SignalitiqueSupReductGroupeDecision() { 
    }
