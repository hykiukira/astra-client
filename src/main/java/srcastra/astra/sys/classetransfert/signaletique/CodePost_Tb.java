 ...
 * @version 
 */
public class CodePost_Tb extends srcastra.astra.sys.rmi.utils.LangueSystem implements java.io.Serializable,returnValueForAlert{

    /** Creates new CodePost_T */
    public CodePost_Tb(int cxcleunik, String cxcode, String cxlocalite, int cxlangue) {
        super();
    ...
    public String[] returnValueForAlert() {
        ...
        returnValue[1]=this.cxcode;
        returnValue[0]=this.cxlocalite;
        return returnValue;
    }
