 ...
 * @author  Thomas
 */
public class LoadDossierTread extends Thread{
    ...
    int threadnumber ;
    Hashtable dossierH;
    public LoadDossierTread(String user,String password,ArrayList array,LockObject parent,int threadnumber,Hashtable dossierH) {
        this.user=user;
