...
public class Agenda {
   ...
   public Agenda(Date date_, Timer timer_, boolean mode_, String avertissement_){
   ...
   public Agenda(Timer timer_, boolean mode_, String avertissement_){
   ...
   public Agenda(Date date_, boolean mode_){
   ...
   public static void main(String [] args){
       ...
       Agenda a = new Agenda(CalculDate.getTodayDate(), true);
